...
def delete_task():
    ...
    if task_index < 0 or task_index > len(tasks) - 1:
        print("Zadanie o tym indeksie nie istenieje")
        return
...
while user_choice !=5:
    ...
    #Stworzenie prostej TO-DO listy która umożliwi wyświetlanie, dodawanie i usuwanie zadań
#aplikacja działać będzie z poziomu konsoli 
#zadania będą przechowywane w pliku tekstowym 
